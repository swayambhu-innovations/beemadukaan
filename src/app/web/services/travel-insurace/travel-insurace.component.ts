...
declare var $:any;
@Component({
  selector: 'app-travel-insurace',
  templateUrl: './travel-insurace.component.html',
  styleUrls: ['./travel-insurace.component.css']
})
export class TravelInsuraceComponent implements OnInit {
